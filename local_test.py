...
if __name__ == '__main__':
    ...
    f_train_path = "dataset/20210619/train/"
    ...
    f_test_path = "dataset/20210619/test/"
    ...
    for count in range(1):
        model = Sequential()
        model.add(Conv1D(filters=240, kernel_size=13, input_shape=(num_timesteps, num_features), activation='relu'))
        model.add(Conv1D(filters=100, kernel_size=7, activation='relu'))
        ...
        errpc = np.percentile(pos_err, 50)
        print("rmse = {:.2f}, median = {:.2f}".format(pos_err_rmse, errpc))
