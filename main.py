...
if __name__ == '__main__':
    ...
    for count in range(2): # 240-140-80-0.4-80 // 80-60-60-80-20 // 21-7-3
        model = Sequential()
        model.add(Conv1D(filters=140, kernel_size=9, input_shape=(num_timesteps, num_features), activation='relu'))
        model.add(Conv1D(filters=140, kernel_size=9, activation='relu'))
