...
if __name__ == '__main__':
    ...
    f_train_path = "/data/users/c3471tl/new_lobby_1dcnn/dataset/lobby/train/"
    ...
    f_test_path = "/data/users/c3471tl/new_lobby_1dcnn/dataset/lobby/test/"
    ...
    # create model
    f_save_path = '/data/users/c3471tl/new_lobby_1dcnn/results/'
    for count in range(10):
        model = Sequential()
        model.add(Conv1D(filters=100, kernel_size=11, input_shape=(num_timesteps, num_features), activation='relu'))
