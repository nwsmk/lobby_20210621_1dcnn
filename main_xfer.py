...
if __name__ == '__main__':
    ...
    # create model
    f_save_path = 'results/'
    model = load_model("model_1dcnn_c2.h5")
    for count in range(2): # 240-140-80-0.4-80 // 80-60-60-80-20 // 21-7-3
        # model = Sequential()
        # model.add(Conv1D(filters=100, kernel_size=9, input_shape=(num_timesteps, num_features), activation='relu'))
        # model.add(Conv1D(filters=100, kernel_size=9, activation='relu'))
