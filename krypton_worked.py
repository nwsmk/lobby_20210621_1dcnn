...
if __name__ == '__main__':
    ...
    f_train_path = "/data/users/c3471tl/lobby_20210621_1dcnn/dataset/20210621/train/"
    ...
    f_test_path = "/data/users/c3471tl/lobby_20210621_1dcnn/dataset/20210621/test/"
    ...
    # create model
    f_save_path = '/data/users/c3471tl/lobby_20210621_1dcnn/'
    for count in range(10):
        model = Sequential()
        model.add(Conv1D(filters=16, kernel_size=9, input_shape=(num_timesteps, num_features), activation='relu'))
        ...
        plt.grid(True)
        plt.savefig(f_save_path + "fig_cdf_1dcnn" + "_c" + str(count) + ".png")
        plt.show()
