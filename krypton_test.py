...
if __name__ == '__main__':
    ...
    # create model
    f_save_path = '/data/users/c3471tl/new_lobby_1dcnn/tests/'
    for count in range(10):
        model = Sequential()
        model.add(Conv1D(filters=200, kernel_size=15, input_shape=(num_timesteps, num_features), activation='relu'))
        ...
        plt.show()
        joblib.dump(cdf_x, "cdf_x_1dcnn.save")
        joblib.dump(cdf_y, "cdf_y_1dcnn.save")
